...
export const alt = 'International Country Codes & Virtual Phone Numbers | Rozper'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ display: 'flex' }}>International</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>Country Codes</span>
        </div>
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          Virtual phone numbers with local presence — instant setup, no hardware needed
        </div>
      </div>
    ),
    { ...size }
