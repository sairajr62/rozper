...
export const alt = 'API Reference · REST & WebSocket Docs | Rozper'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ display: 'flex' }}>REST &amp; WebSocket</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>Docs</span>
        </div>

        {/* Subtext */}
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          Every endpoint, every parameter, every error code — 8 language examples
        </div>
      </div>
    ),
    { ...size }
