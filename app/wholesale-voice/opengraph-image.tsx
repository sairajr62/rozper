...
export const alt = 'Wholesale Voice Solutions · Global VoIP Termination | Rozper'
      ...
      >
        ...
        >
          <div style={{ color: '#22D3EE', fontSize: '14px', fontWeight: 600, display: 'flex' }}>
            200+ Countries · 99.99% Uptime SLA
          </div>
        </div>
        <div
          style={{
        ...
        >
          <span style={{ display: 'flex' }}>Wholesale Voice</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>Global VoIP Termination</span>
        </div>
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          A-Z routes · SIP trunking · DID &amp; toll-free numbers
        </div>
      </div>
    ),
    { ...size }
