...
export const alt = "About Rozper · Carrier-Grade UCaaS & Contact Center Platform"
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ display: "flex" }}>About Rozper</span>
        </div>

        {/* Subhead */}
        <div style={{ display: "flex", color: "rgba(255,255,255,0.6)", fontSize: "20px" }}>
          Carrier-grade UCaaS &amp; contact center, built so every call just works
        </div>
      </div>
    ),
    { ...size },
