...
export const alt = 'Contact Sales & Support · Get in Touch | Rozper'
      ...
      >
        ...
        >
          <div style={{ color: '#22D3EE', fontSize: '14px', fontWeight: 600, display: 'flex' }}>
            Talk to us in under 60 seconds
          </div>
        </div>
        <div
          style={{
        ...
        >
          <span style={{ display: 'flex' }}>Contact</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>Sales &amp; Support</span>
        </div>
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          Build the right UCaaS + AI plan for your volume, regions, and integrations
        </div>
      </div>
    ),
    { ...size }
