...
export const alt = 'U.S. Area Code Virtual Phone Numbers | Rozper'
    ...
    (
      ...
      >
        ...
        >
          ...
          <span style={{ display: 'flex', color: '#22D3EE' }}>for Any U.S. Area Code</span>
        </div>
        {/* Subtitle */}
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '22px', display: 'flex' }}>
          Instant local presence across all 50 states — powered by Rozper
        </div>
      </div>
    ),
    { ...size }
