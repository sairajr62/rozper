...
export const alt = 'Blog · Field notes from the global voice layer | Rozper'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ display: 'flex' }}>Field notes from the</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>global voice layer</span>
        </div>
        {/* Subtitle */}
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          Research, deep-dives &amp; operator playbooks — 2.4M+ daily calls across 150+ countries
        </div>
      </div>
    ),
    { ...size }
