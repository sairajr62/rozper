...
export const alt = 'Wholesale VoIP · Global Voice Termination | Rozper'
      ...
      >
        ...
        >
          <div style={{ color: '#22D3EE', fontSize: '14px', fontWeight: 600, display: 'flex' }}>
            200+ Countries · Direct A-Z Routes
          </div>
        </div>
        <div
          style={{
        ...
        >
          <span style={{ display: 'flex' }}>Wholesale VoIP</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>Global Voice Termination</span>
        </div>
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          Built for carriers, VoIP providers &amp; telecom operators
        </div>
      </div>
    ),
    { ...size }
