      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": { "@type": "Answer", "text": "Rozper's Hosted Phone System is a fully cloud-hosted phone solution with extensions, hunt groups, IVR, and dial plans running on a carrier-grade network — no hardware or on-premise equipment required." }
        },
        {
          "@type": "Question",
