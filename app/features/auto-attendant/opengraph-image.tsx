...
export const alt = 'Auto-Attendant & Visual IVR Builder | Rozper'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ display: 'flex' }}>Visual IVR Builder</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>No Code Needed</span>
        </div>
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          Multi-level auto-attendant — route calls correctly from the first ring
        </div>
      </div>
    ),
    { ...size }
