...
export const alt = 'AI Agent Assist · Live Whisper Coaching for Every Call | Rozper'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ display: 'flex' }}>Live Whisper Coaching</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>for Every Call</span>
        </div>
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          AI whispers answers, surfaces articles, and scores calls in real time
        </div>
      </div>
    ),
    { ...size }
