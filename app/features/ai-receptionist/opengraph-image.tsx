...
export const alt = 'AI Receptionist · Automated 24/7 Call Answering | Rozper'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ display: 'flex' }}>Automated</span>
        ...
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          Answers, qualifies, routes &amp; books — no missed calls, CRM sync included
        </div>
      </div>
    ),
    { ...size }
