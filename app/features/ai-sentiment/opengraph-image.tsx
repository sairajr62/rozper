...
export const alt = 'AI Sentiment Analysis · Real-Time Call Emotion Scoring | Rozper'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ display: 'flex' }}>Real-Time</span>
          <span style={{ display: 'flex', color: '#22D3EE' }}>Call Emotion Scoring</span>
        </div>
        <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '20px', display: 'flex' }}>
          Live sentiment on every call — supervisors alerted instantly when calls go negative
        </div>
      </div>
    ),
    { ...size }
