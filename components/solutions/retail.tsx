...
const dark = [
  ...
  '99.999% uptime SLA on your highest traffic day',
    ...
    <main className="min-h-screen bg-[#0B1220]">
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 py-24">
          <div className="rounded-3xl border border-[#046BD2]/20 bg-[#046BD2]/5 p-10">
            <Activity className="w-8 h-8 text-[#0086F9] mb-4" />
            <blockquote className="font-display text-xl md:text-2xl font-medium leading-relaxed">
              "We tripled our contact center capacity for the holiday season in two days. Rozper handled the surge without a single outage."
            </blockquote>
            <div className="mt-6 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#046BD2]/20 border border-[#046BD2]/30 flex items-center justify-center text-[#2D98F1] font-display font-bold">AT</div>
              <div>
                <div className="font-semibold">Adriana Torres</div>
                <div className="text-xs text-white/50">CX Director · Luminary Commerce</div>
              </div>
            </div>
          </div>
        </section>
