  ...
  return (
    <main className="min-h-screen bg-[#0B1220]">
      ...
      <div className="relative z-10">
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-white/[0.06]">
                    ...
                    <div>
                      ...
                      <div className="font-mono text-xs text-white/65 mt-0.5">{t.role}</div>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-24">
          <div className="relative rounded-3xl overflow-hidden bg-[#0B1220] border border-white/10 p-6 sm:p-12 md:p-16 text-center">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-row flex-wrap items-center justify-center gap-2 sm:gap-3">
                <Link href="/contact/" className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-6 sm:py-3.5 rounded bg-[#0D9488] hover:bg-[#0F766E] text-white text-xs sm:text-sm whitespace-nowrap font-semibold shadow-[0_0_40px_-10px_rgba(13,148,136,0.7)] transition">
                  <span className="font-mono">$ rozper init</span> <ArrowRight className="w-4 h-4" />
                </Link>
                <Link href="/pricing/" className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-7 sm:py-4 rounded-full bg-white/[0.04] border border-white/15 hover:bg-white/10 text-white text-xs sm:text-sm whitespace-nowrap font-semibold transition">See pricing</Link>
              </div>
            </div>
          </div>
        </section>
