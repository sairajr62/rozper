...
const footerColumns = [
  {
    ...
    links: [
      { label: 'Business Phone System', href: '/products/unified-communications/business-phone-system/' },
      { label: 'HD Video Meetings', href: '/products/unified-communications/hd-video-meetings/' },
      { label: 'Business SMS & MMS', href: '/products/unified-communications/business-sms-mms/' },
