  ...
  return (
    <main className="min-h-screen bg-[#0B1220]">
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-24">
          <div className="relative rounded-3xl overflow-hidden bg-[#0B1220] border border-white/10 p-4 sm:p-6 sm:p-12 md:p-20 text-center">
            {/* Left arc glow */}
            ...
            <div className="relative">
              ...
              <div className="mt-10 flex flex-row flex-wrap items-center justify-center gap-2 sm:gap-3">
                <Link href="/contact/" className="inline-flex items-center gap-2 px-3 py-2.5 sm:px-7 sm:py-4 rounded-full bg-[#F59E0B] hover:bg-[#D97706] text-white shadow-[0_0_40px_-10px_rgba(245,158,11,0.7)] text-xs sm:text-base font-semibold transition whitespace-nowrap">
