...
const features = [
  ...
  {
    icon: TrendingUp,
    title: "Historical Trend Reports",
...
const faqs = [
  {
    ...
    a: "Under 5 seconds. Live dashboards update continuously — no page refresh needed.",
  },
  {
    q: "Can supervisors get alerts on SLA breaches?",
    a: "Yes. Configure threshold alerts via email, SMS, or Slack when SLA, queue depth, or wait time exceed limits.",
  },
  {
      ...
      <div className="p-5 border-b border-white/5">
        ...
        <div className="flex items-end gap-1 h-16">
          {chartBars.map((h, i) => (
            <motion.div
              key={i}
              className="flex-1 rounded-t bg-gradient-to-t from-[#046BD2] to-[#0086F9]"
              initial={{ height: 0 }}
              animate={{ height: `${h}%` }}
      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {kpiData.map((kpi, i) => (
            ...
            >
              <div className="text-[9px] font-mono text-white/35 mb-1">
                {kpi.label}
              </div>
              <div className="flex items-baseline gap-2">
                ...
                <span
                  className={`text-[9px] font-mono ${kpi.good ? "text-emerald-400" : "text-red-400"}`}
                >
                  {kpi.delta}
                </span>
              </div>
            ...
            {conversationFeedback.map((f, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="relative mt-5 font-display font-semibold text-white">
                    {f.title}
                  </h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between">
                    ...
                    <span className={`font-mono text-3xl font-bold bg-gradient-to-br ${accent} bg-clip-text text-transparent opacity-40`}>
                      {String(i + 1).padStart(2, "0")}
                    </span>
                  </div>
                  <h3 className="relative mt-5 font-display font-semibold text-white">
          ...
          <div className="relative rounded-3xl overflow-hidden bg-[#0B1220] border border-white/10 p-6 sm:p-6 sm:p-12 md:p-20 text-center">
            ...
            <div className="relative">
              ...
              <div className="mt-10 flex flex-row flex-wrap items-center justify-center gap-2 sm:gap-3">
                ...
                <Link
                  href="/pricing/"
                  className="inline-flex items-center gap-2 px-3 py-2.5 sm:px-7 sm:py-4 rounded-full bg-white/[0.04] border border-white/15 hover:bg-white/10 text-xs sm:text-base text-white font-semibold transition whitespace-nowrap"
                >
                  See pricing
                </Link>
              </div>
