...
export function ReceptionistHero() {
  ...
  return (
    <div
      ref={wrapRef}
      className="flex items-center justify-center gap-5 select-none relative scale-[0.56] sm:scale-[0.70] md:scale-[0.75] lg:scale-[0.75] xl:scale-[0.88] 2xl:scale-100 origin-top"
    >
      {/* Ambient glow */}
